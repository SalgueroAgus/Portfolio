let resumeData = {
  ...
  socialLinks: [
    {
      name: "LinkedIn",
      link: "www.linkedin.com/in/salgueroagustin",
  ...
  projectModals: [
    ...
    },
    {
      ...
      projectDetails:
        "Bckend Only using NodeJS, MySQL and Express. Online ordering system for a restaurant. REST API that allows users to register, cancel, modify and obtain information about a data structure that a customer could consume.",
